...
4. **Copy Template**: Copy all files from `<Templates-Dir>/design-project/` into `<Projects-Dir>/<project-name>/`.
...
7. **Save Answers**: Once the user answers, update the `<Projects-Dir>/<project-name>/FOLDER-INSTRUCTIONS.md` Layer 4 section with their answers.
